...
// Якщо такий елемент є в масиві, то поверніть його індекс,
// якщо ні — метод повинен повернути число - «-1». Використовуй оператори порівняння.
...
public class Task6 {
    ...
    System.out.print("Введіть число від 1 до 5:");
